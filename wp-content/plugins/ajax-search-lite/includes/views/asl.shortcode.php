...
<div class="probox">
    ...
    <div class='proinput'>
        <form autocomplete="off">
            <input type='search' class='orig search_ajax' name='phrase' placeholder='<?php echo asl_icl_t( "Search bar placeholder text", w_isset_def($style['defaultsearchtext'], '') ); ?>' value='<?php echo get_search_query(); ?>' autocomplete="off"/>
